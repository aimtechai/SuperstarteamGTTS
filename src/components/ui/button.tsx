  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-base font-medium ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        ...
        // Custom variants for the reference dashboard
        pill: "rounded-full border border-border bg-background text-foreground hover:bg-accent",
        pillPrimary:
          "rounded-full bg-primary text-primary-foreground shadow-sm hover:bg-primary/90",
        pillWarning:
          "rounded-full bg-warning text-warning-foreground shadow-sm hover:bg-warning/90",
        pillOutlinePrimary:
          "rounded-full border border-primary bg-transparent text-primary hover:bg-primary/10",
        soft: "rounded-lg bg-secondary text-secondary-foreground",
      },
      size: {
