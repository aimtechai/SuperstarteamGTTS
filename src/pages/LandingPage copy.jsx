  ...
  return (
    <ExternalLayout>
      <section
        style={{
          backgroundImage: `
                    linear-gradient(90deg, #072E60 0%, #D9D9D900 55%, rgba(217,217,217,0) 100%),
                    url(${heroBg})
                    `,
              ...
              <Row className="align-items-center g-4">
                ...
                <Col lg={6}>
                  <div className="d-flex flex-column gap-3">
                    ...
                    {/* Bullet list with check-circle badges */}
                    <div className="d-flex flex-column gap-2">
                      ...
                      {/* Fastest sign-up with brand icons */}
                    ...
                    <p className="m-0" style={{ color: "#FFFFFF" }}>
                      <strong>Try our course for free</strong> — if you&apos;re
                      not totally satisfied before taking the final exam,
                      don&apos;t pay!
                    </p>
                    ...
                    {/* Disclaimer */}
                    <div className="small" style={{ color: "#DDE7F0" }}>
      ...
      <section className="py-5 bg-white">
        <Container>
          <h1 className="text-center fw-bold mb-4" style={{ color: "#004985", fontSize: 32 }}>
            We Also Offer
          </h1>
          ...
          <Row className="align-items-center g-4">
            ...
            <Col lg={6}>
              <div className="d-flex flex-column align-items-start text-start">
                ...
                <div
                  className="mt-3"
                  style={{ fontSize: 16, color: "#004985" }}
                >
                  <div>
      ...
      <section className="py-5 bg-white">
        <Container style={{ padding: "0 100px" }}>
          ...
          <h2 className="mb-1" style={{ color: "#004985", fontWeight: 800, fontSize: 32 }}>
            PARTNER WITH US
          </h2>
          <div
            className="h5 mb-3"
          ...
          <Row className="g-4">
            ...
            <Col md={6}>
              ...
              >
                {/* Image (no padding) */}
                <div className="p-0" style={{ flex: "0 0 40%" }}>
                  <img
                    src={section7Image1}
                ...
                <div
                  ...
                  style={{ flex: "1 1 auto" }}
                >
                  <div style={{ color: "#004985", fontWeight: 600 }}>
            ...
            <Col md={6}>
              ...
              >
                ...
                >
                  <div style={{ color: "#004985", fontWeight: 600 }}>
                    Promote online traffic school and defensive driving courses
                    in over 18 states.
                  </div>
                </div>
              </div>
      ...
      <section className="py-5 bg-white">
        <Container style={{ padding: "0 100px" }}>
          <Row className="align-items-center g-4">
            ...
            <Col md={8}>
              <h1
                style={{ color: "#004985", fontWeight: 800, lineHeight: 1.1 }}
              >
                MAKE MONEY THROUGH GTTS!
              </h1>
              ...
              >
                ...
                <li>
                  Do you want to start offering an online traffic school course
              ...
              <p
                className="mt-2"
                style={{ fontSize: 14, color: "#004985", maxWidth: 560 }}
              >
                If you answered yes to all of those above questions then you
                must watch this short video. It will change your business
              </p>
      ...
      <footer
        ...
        style={{ background: "#E7F4FF", color: "#004985" }}
      >
        <Container style={{ padding: "0 100px" }}>
          <Row className="footer-cols py-5 g-4">
            {/* Col 1 */}
            <Col xs={12} md={6} lg={3} className="footer-col px-4">
        ...
        <div className="py-3" style={{ background: "#FFFFFF" }}>
          <Container style={{ padding: "0 100px" }}>
            <div
              ...
              style={{ color: "#004985", fontWeight: 600 }}
            >
